...
| [PLAN-4-expansion.md](PLAN-4-expansion.md) | ⏳ **awaiting adoption** | The wider-world expansion (Montevideo, Basra, whaling grounds, Hudson Bay, Port Louis…). Four adoption decisions flagged in its §3. |
| [PLAN-6-era-1850.md](PLAN-6-era-1850.md) | ⏳ **awaiting adoption** | The temporal expansion: era 1550→1850, decade reset 1850→1860 (310-yr loop). Rides PLAN-3's machinery; six adoption decisions in its §6 (steam boundary, illegal-era slave trade, sequencing vs. PLAN-4/RC…). |
